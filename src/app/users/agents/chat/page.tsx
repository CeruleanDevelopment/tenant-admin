...
export default function FloatingAIWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {open && (
        <div className="flex h-[min(720px,85vh)] w-105 max-w-[95vw] flex-col overflow-hidden rounded-[34px] border border-white/40 bg-white/50 shadow-[0_20px_80px_rgba(15,23,42,0.12)] backdrop-blur-3xl">
          ...
          <div className="border-t border-white/30 bg-white/40 p-4 backdrop-blur-3xl">
            ...
            <p className="mt-3 text-center text-xs text-slate-500">
              AI Assistant may produce incorrect information.
            </p>
          </div>
        </div>
      )}
